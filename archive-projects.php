   ...
   <div class="featured-cat clearfix">
            ...
            if ($get_featured_project->have_posts()) :
               ...
               while ($get_featured_project->have_posts()) : $get_featured_project->the_post(); ?>
                ...
                <div class="feature-blurb">
                    ...
                    <span class="date"><?php echo get_the_date(); ?> &bull; <?php if (get_the_term_list( $ID, 'project-categories', '', ', ', '' )): ?> <?php echo get_the_term_list( $ID, 'project-categories', '', ', ', '' ) ?><?php endif; ?></span>
                    <p>
                          <?php      
          ...
          // wp query 
            ...
            if ($get_projects->have_posts()) :
                ...
                echo do_shortcode('[ajax_load_more post_type="projects" posts_per_page="12" scroll="false" container_type="div" button_label="Load More" custom_args="post__not_in:'.$featuredID.',"]'); 
